...
urlpatterns = [
    ...
    url(r'^users/updatepwd/(?P<uid>[0-9]+)$', users.resetpassword, name="myadmin_users_resetpwd"),
    url(r'^users/updatepwd$', users.updatepwd, name="myadmin_users_updatepwd"),     
    url(r'^users/query$', users.query, name="myadmin_users_query"),   
